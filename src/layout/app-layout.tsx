...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['pharmacist', 'owner', 'manager', 'sales-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Medicine', path: '/medicines', entity: 'medicine', service: AccessServiceEnum.PROJECT, icon: FiPackage },
