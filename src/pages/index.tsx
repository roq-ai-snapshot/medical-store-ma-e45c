  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Medical Store Management - Streamlining Your Pharmacy Operations, Optimizing Medicine Stock and Sales Management."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwc3RvcmV8ZW58MHx8fHwxNjg5NzcyNDI4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Medical Store Management - Streamlining Your Pharmacy Operations, Optimizing Medicine Stock and Sales Management.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Pharmacist" type="pharmacist" />
